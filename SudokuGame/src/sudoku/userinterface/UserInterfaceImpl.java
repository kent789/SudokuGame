...
public class UserInterfaceImpl implements IUserInterfaceContract.View, EventHandler<KeyEvent> {
    ...
    private static final Color BOARD_BACKGROUND_COLOR = Color.NAVAJOWHITE;
    private static final Color BOARD_TITLE_COLOR = Color.SLATEGREY;
    private static final String SUDOKU = "Good luck!";
    ...
    private void drawTitle(Group root) {
        ...
        title.setFill(BOARD_TITLE_COLOR);
    ...
    public void updateBoard(SudokuGame game){
        for (int xIndex = 0; xIndex < 9; xIndex++){
            for (int yIndex = 0; yIndex < 9; yIndex++){
                ...
                // if a given tile has a non zero value and the state of the game is GameState.NEW, then
                // mark the tile as read only. Otherwise ensure that it is not READ only
